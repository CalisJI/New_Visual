...
namespace Camera_Check_Component
{
    ...
    { 
        ...
        private void serialPort_communicate_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            if(cap_order == "D" && ready1 && begin_ok1) 
            {
                if (!wr1)
                {
                    if (load1 == load2)
            ...
            if (cap_order == "D" && ready2 && begin_ok2)
            {
                if (!wr2)
                {
                    if (load2 == load1)
            ...
            if (cap_order == "D" && ready1 && begin_ng1)
            {
                if (!wr1)
                {
                    if (load1 == load2)
            ...
            if (cap_order == "D" && ready2 && begin_ng2)
            {
                if (!wr2)
                {
                    if (load2 == load1)
        ...
        private void upload_image()
        {
            ...
            else
            {
                pictureBox3.Image = null;
                Hname3.Text = "";
                //c/*1h3_1.Visible = false; c2h3_1.Visible = false;*/
            }
            if (path_1_4 != "")
            {
                ...
                //c5_14.Visible = true; c4_14.Visible = true;
            }
            else
            {
                pictureBox4.Image = null;
                Hname4.Text = "";
                //c5_14.Visible = false; c4_14.Visible = false;
            }
            if (path_1_5 != "")
            {
                ...
                //c4_15.Visible = true; c8_15.Visible = true;
            }
            else
            {
                pictureBox5.Image = null;
                Hname5.Text = "";
                //c4_15.Visible = false; c8_15.Visible = false;
            }
            if (path_1_6 != "")
            {
        ...
        private void Tranfer(string OPTION)
        {
            if (OPTION == "OK" && allow_check)
            {
                ...
                if (!Directory.Exists(system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH))
                {
                    Directory.CreateDirectory(system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH);
                }
                ...
                MethodInvoker inv = delegate
                {
                    ...
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_1, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator1 + "-" + path_1_1);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_2, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator1 + "-" + path_1_2);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_3, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator1 + "-" + path_1_3);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_4, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator1 + "-" + path_1_4);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_5, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator1 + "-" + path_1_5);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_6, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator1 + "-" + path_1_6);
                    if (system_config.add_cam == "true")
                    {
                        File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_7, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator1 + "-" + path_1_7);
                    }
                };this.Invoke(inv);
            ...
            if (OPTION == "ERROR" && allow_check)
            {
                ...
                if (!Directory.Exists(system_config.Map_Path_File + @"/"+ Parameter_app.ERROR_IMAGE_FOLDER_PATH))
                {

                    Directory.CreateDirectory(system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH); 
                }
                MethodInvoker inv = delegate
                {
                    pictureBox1.Image.Dispose();
                    ...
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_1, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam1) + "-" + ID_Operator1 + "-" + path_1_1);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_2, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam1) + "-" + ID_Operator1 + "-" + path_1_2);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_3, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam1) + "-" + ID_Operator1 + "-" + path_1_3);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_4, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam1) + "-" + ID_Operator1 + "-" + path_1_4);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_5, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam1) + "-" + ID_Operator1 + "-" + path_1_5);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_1_6, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam1) + "-" + ID_Operator1 + "-" + path_1_6);
                    if (system_config.add_cam == "true")
                    {
                        File.Move(system_config.Map_Path_File + @"/" + path_1_7, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam1) + "-" + ID_Operator1 + "-" + path_1_7);
                    }
                };this.Invoke(inv);
        ...
        private void Tranfer1(string OPTION)
        {
            if (OPTION == "OK" && allow_check)
            {
                ...
                MethodInvoker inv = delegate
                {
                    ...
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_1, system_config.Map_Path_File + @"/"+ Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator2 + "-" + path_2_1);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_2, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator2 + "-" + path_2_2);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_3, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator2 + "-" + path_2_3);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_4, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator2 + "-" + path_2_4);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_5, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator2 + "-" + path_2_5);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_6, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator2 + "-" + path_2_6);
                    if (system_config.add_cam == "true")
                    {
                        File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_7, system_config.Map_Path_File + @"/" + Parameter_app.OK_IMAGE_FOLDER_PATH + "/" + "OK-" + ID_Operator2 + "-" + path_2_7);
                    }
                };this.Invoke(inv);
            ...
            if (OPTION == "ERROR" && allow_check)
            {
                ...
                MethodInvoker inv = delegate
                {
                    ...
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_1, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam2) + "-" + ID_Operator2 + "-" + path_2_1);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_2, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam2) + "-" + ID_Operator2 + "-" + path_2_2);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_3, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam2) + "-" + ID_Operator2 + "-" + path_2_3);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_4, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam2) + "-" + ID_Operator2 + "-" + path_2_4);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_5, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam2) + "-" + ID_Operator2 + "-" + path_2_5);
                    File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_6, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam2) + "-" + ID_Operator2 + "-" + path_2_6);
                    if (system_config.add_cam == "true")
                    {
                        File.Move(system_config.Map_Path_File + @"\" + Parameter_app.IMAGE_FOLDER_PATH + "/" + path_2_7, system_config.Map_Path_File + @"/" + Parameter_app.ERROR_IMAGE_FOLDER_PATH + "/" + error_Type(loi_tam2) + "-" + ID_Operator2 + "-" + path_2_7);
                    }
                };this.Invoke(inv);
